  ...
  #  import env
    ...
    for name in master_names:
        ...
        if tools.analyticsTools[name]['kind'].upper() == 'POSTGRES':
            os.system('source %s && pg_ctl start -w -D %s'%(tools.analyticsTools[name]['env'], tools.analyticsTools[name]['master_dir'] ))
        else:
        ...
        # Tear Down
        if tools.analyticsTools[name]['kind'].upper() == 'POSTGRES':
            os.system('source %s && pg_ctl stop -w -D %s'%(tools.analyticsTools[name]['env'], tools.analyticsTools[name]['master_dir']))
        else:
